...
Start1[ /recall 或 codegraph init ]
Start2[ /plan /superpowers:brainstorming /superpowers:writing-plans ]
Start3[ /understand /understand-dashboard ]
Start4[ /plan ]
Start5[ /init ]

Frontend1[ /design-taste-frontend /impeccable init /find-animation-opportunities ]
Frontend3[ /redesign-existing-project /prototype /improve-animations ]
Frontend2[ /impeccable + 具体修改内容 ]

Step1[ /setup-matt-pocock-skills /ask-matt ]
Step2[ 具体修改细节、后续功能等 ]

Finish1[ /remember codegraph sync ]
