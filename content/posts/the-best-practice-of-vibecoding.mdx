...
7. 提供/生成合适的 skills/plugins 供 ai 规范流程

> 此外，对于多 agents 并行，claude code 采用了不同的策略 [Run agents in parallel](https://code.claude.com/docs/en/agents) 来适配各种项目
> 至于更多命令细节可参考：[best-practices-for-prompt-engineering](https://claude.com/blog/best-practices-for-prompt-engineering)
...
Step1 -->|对于前端部分|Frontend1 --> Frontend3 --> Frontend2
Frontend3 --> Frontend3
Frontend2 --> Step2
