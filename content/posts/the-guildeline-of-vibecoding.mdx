...
3. 对于每一处特定函数修改，强调使用 `/codebase-memory`（或其他相关技能）
...
> 至于更多命令细节可参考：[best-practices-for-prompt-engineering](https://claude.com/blog/best-practices-for-prompt-engineering)、[codex_prompting_guide](https://developers.openai.com/cookbook/examples/gpt-5/codex_prompting_guide)
